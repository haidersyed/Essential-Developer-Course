...
class CodableFeedStoreTests: XCTestCase  {
    ...
    func test_delete_hasNoSideEffectsOnEmptyCache() {
        ...
        XCTAssertNil(deletionError, "Expected empty cahce deletion to succeed")
        expect(sut, toRetrieve: .empty)
    }
    ...
    func test_delete_emptiesPreviouslyInsertedCache() {
        ...
        XCTAssertNil(deletionError, "Expected non-empty cahce deletion to succeed")
        expect(sut, toRetrieve: .empty)
    }
    ...
    func test_storeSideEffects_runSerially(){
        ...
        let op2 = expectation(description: "Operaton 2")
        sut.deleteCachedFeed{ _ in
            completedOperationInOrder.append(op2)
            op2.fulfill()
        }
        
        let op3 = expectation(description: "Operaton 3")
        sut.insert(uniqueImageFeed().local, timestamp: Date()){ _ in
